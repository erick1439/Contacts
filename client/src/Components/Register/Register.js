            ...
            <div className="auth-inner">
                ...
                <form onSubmit={submitHandler}>
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" className="form-control" placeholder="First name" onChange={event => setFirstName(event.target.value)} name="firstName" />
                    </div>

                    <div className="form-group">
                        <label>Last name</label>
                        <input type="text" className="form-control" placeholder="Last name" onChange={event => setLastName(event.target.value)} name="lastName" />
                    </div>
